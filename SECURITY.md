...
Please check the table below to see which versions of Vruttaant are currently being supported with security updates.
...
- Once the issue is resolved, we will publish a security advisory and credit you for the discovery (if desired).
