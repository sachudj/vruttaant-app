...
const { ingestNewsFromUrl, getNewsCards, getRecommendedCards, translateNewsStory } = require('../controllers/newsController');
...
router.get('/recommended', optionalAuth, validateRequest('query', validateRecommendedQuery), getRecommendedCards);
